...
router_agent = Agent(get_model(), deps_type=RouterDeps, system_prompt=ROUTER_PROMPT)
...
async def web_search_node(state: RouterState, writer) -> dict:
    ...
    return {"final_response": full_response, "agent_type": "web_search", "message_history": [new_messages]}
...
async def rag_search_node(state: RouterState, writer) -> dict:
    ...
    return {"final_response": full_response, "agent_type": "rag_search", "message_history": [new_messages]}
...
async def code_execution_node(state: RouterState, writer) -> dict:
    ...
    return {"final_response": full_response, "agent_type": "code_execution", "message_history": [new_messages]}
...
async def sql_query_node(state: RouterState, writer) -> dict:
    ...
    return {"final_response": full_response, "agent_type": "sql_query", "message_history": [new_messages]}
...
async def fallback_node(state: RouterState, writer) -> dict:
    ...
    return {"final_response": full_response, "agent_type": "fallback", "message_history": [new_messages]}
