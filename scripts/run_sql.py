...
def get_connection():
    ...
    user = os.getenv("SUPABASE_DB_USER") or os.getenv("DB_USER", "postgres")
    ...
    if not host or not password:
        ...
        print("  2. SUPABASE_DB_HOST, SUPABASE_DB_PASSWORD, etc.")
        print("")
...
def run_sql_file(cursor, filepath: Path) -> None:
    ...
    # But be careful with functions that contain semicolons inside $$ blocks
    cursor.execute(sql)
